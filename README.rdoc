...
This pluging bind Events in Redmine with Actions in Playlyfe game (N:M).
And Users in Redmine with Players in Playlyfe game (N:1).

<b>You have to setup a client at PlaylyfeClient</b> which can access API (only paid plans) form your backend.
...
In configuration page, you can setup these bindings:
